...
def ros2dict(msg):
    ...
    if hasattr(msg, "get_fields_and_field_types"):  # ROS2
        ...
        raise ValueError(
            "ros2dict: Does not appear to be a simple type or a ROS message: %s" % str(msg))
    ...
    for field in fields_and_field_types:
        ...
        if (msg.__module__ == "sensor_msgs.msg._CompressedImage" or
                ...
                and field == "data":
            ros_source_codes.compression.compress_compressed_image(msg, output)
            continue
        ...
        if (msg.__module__ == "sensor_msgs.msg._Image" or
                ...
                and field == "data":
            ros_source_codes.compression.compress_image(msg, output)
            continue
        ...
        if (msg.__module__ == "nav_msgs.msg._OccupancyGrid" or
                ...
                and field == "data":
            ros_source_codes.compression.compress_occupancy_grid(msg, output)
            continue
        ...
        if (msg.__module__ == "sensor_msgs.msg._LaserScan" or
                ...
                and field == "ranges":
            ros_source_codes.compression.compress_laser_scan(msg, output)
            continue
        if (msg.__module__ == "sensor_msgs.msg._LaserScan" or
                msg.__module__ == "sensor_msgs.msg._laser_scan") \
        ...
        if (msg.__module__ == "sensor_msgs.msg._PointCloud2" or
                ...
                and field == "data":
            ros_source_codes.compression.compress_point_cloud2(msg, output)
            continue
