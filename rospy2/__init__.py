...
def logdebug(text):
    return _logger.debug(text)


def logdebug_once(text):
    return _logger.debug(text, once=True)


def logdebug_throttle(interval, text):
    return _logger.debug(text, throttle_duration_sec=interval)


def loginfo(text):
    return _logger.info(text)


def loginfo_once(text):
    return _logger.info(text, once=True)


def loginfo_throttle(interval, text):
    return _logger.info(text, throttle_duration_sec=interval)


def logwarn(text):
    return _logger.warn(text)


def logwarn_once(text):
    return _logger.warn(text, once=True)


def logwarn_throttle(interval, text):
    return _logger.warn(text, throttle_duration_sec=interval)


def logerr(text):
    return _logger.error(text)


def logerr_once(text):
    return _logger.error(text, once=True)


def logerr_throttle(interval, text):
    return _logger.error(text, throttle_duration_sec=interval)


def logfatal(text):
    return _logger.fatal(text)


def logfatal_once(text):
    return _logger.fatal(text, once=True)


def logfatal_throttle(interval, text):
    return _logger.fatal(text, throttle_duration_sec=interval)
...
def get_caller_id():
    ...
    logwarn_once(
        "get_caller_id() not supported in ROS2. taking a guess by selecting the first publisher. highly recommended to not do this!"
    )
...
class Publisher(object):
    def __init__(self, topic_name, topic_type, queue_size=1):
        ...
        self._pub = _node.create_publisher(
            ...
            rclpy.qos.QoSProfile(
                depth=queue_size, history=rclpy.qos.HistoryPolicy.KEEP_LAST
            ),
        )
    ...
    def md5sum(self):  # No good ROS2 equivalent, fake it reasonably
        return hashlib.md5(
            str(self.type.get_fields_and_field_types()).encode("utf-8")
        ).hexdigest()
...
# 31/07/2023 : Mudei o profile do qos de 10 para qos_profile_sensor_data
class Subscriber(object):
    def __init__(self, topic_name, topic_type, callback, callback_args=None):
        global _node
        qos_profile = 10
        if _ros2_type_to_type_name(topic_type) == "sensor_msgs.msg._image.Image":
        ...
        self._sub = _node.create_subscription(
            topic_type,
            topic_name,
            self._ros2_callback,
            qos_profile,
...
class WaitForServiceTimeout(Exception):
    """
    Exception raised when the wait for a service reaches the timeout.
    Atrributes
    ...
    def __init__(self, message=None):
        if message is not None:
            ...
            self.message = "Timeout reached without finding the service."
...
try:
    ...
    diagnostic_msgs.msg.KeyValue.__init__ = (
        lambda self, key="", value="": diagnostic_msgs.msg.KeyValue.__oldinit__(
...
try:
    ...
    geometry_msgs.msg.Quaternion.__init__ = lambda self, x=0.0, y=0.0, z=0.0, w=0.0: geometry_msgs.msg.Quaternion.__oldinit__(
        self, x=float(x), y=float(y), z=float(z), w=float(w)
    )
    geometry_msgs.msg.Point.__oldinit__ = geometry_msgs.msg.Point.__init__
    geometry_msgs.msg.Point.__init__ = (
        lambda self, x=0.0, y=0.0, z=0.0: geometry_msgs.msg.Point.__oldinit__(
            self, x=float(x), y=float(y), z=float(z)
        )
    )
    geometry_msgs.msg.Point32.__oldinit__ = geometry_msgs.msg.Point32.__init__
    geometry_msgs.msg.Point32.__init__ = (
        lambda self, x=0.0, y=0.0, z=0.0: geometry_msgs.msg.Point32.__oldinit__(
            self, x=float(x), y=float(y), z=float(z)
        )
    )
except ImportError:
...
try:
    ...
    tf2_ros.static_transform_broadcaster.StaticTransformBroadcaster.__init__ = lambda self: tf2_ros.static_transform_broadcaster.StaticTransformBroadcaster.__oldinit__(
        self, _node
    )
except:
    pass
...
std_msgs.msg.Bool.__init__ = lambda self, data=False: std_msgs.msg.Bool.__oldinit__(
    self, data=data
)
std_msgs.msg.Byte.__oldinit__ = std_msgs.msg.Byte.__init__
std_msgs.msg.Byte.__init__ = lambda self, data=0: std_msgs.msg.Byte.__oldinit__(
    self, data=data
)
std_msgs.msg.Char.__oldinit__ = std_msgs.msg.Char.__init__
std_msgs.msg.Char.__init__ = lambda self, data=0: std_msgs.msg.Char.__oldinit__(
    self, data=data
)
std_msgs.msg.Int8.__oldinit__ = std_msgs.msg.Int8.__init__
std_msgs.msg.Int8.__init__ = lambda self, data=0: std_msgs.msg.Int8.__oldinit__(
    self, data=data
)
std_msgs.msg.Int16.__oldinit__ = std_msgs.msg.Int16.__init__
std_msgs.msg.Int16.__init__ = lambda self, data=0: std_msgs.msg.Int16.__oldinit__(
    self, data=data
)
std_msgs.msg.Int32.__oldinit__ = std_msgs.msg.Int32.__init__
std_msgs.msg.Int32.__init__ = lambda self, data=0: std_msgs.msg.Int32.__oldinit__(
    self, data=data
)
std_msgs.msg.Int64.__oldinit__ = std_msgs.msg.Int64.__init__
std_msgs.msg.Int64.__init__ = lambda self, data=0: std_msgs.msg.Int64.__oldinit__(
    self, data=data
)
std_msgs.msg.UInt8.__oldinit__ = std_msgs.msg.UInt8.__init__
std_msgs.msg.UInt8.__init__ = lambda self, data=0: std_msgs.msg.UInt8.__oldinit__(
    self, data=data
)
std_msgs.msg.UInt16.__oldinit__ = std_msgs.msg.UInt16.__init__
std_msgs.msg.UInt16.__init__ = lambda self, data=0: std_msgs.msg.UInt16.__oldinit__(
    self, data=data
)
std_msgs.msg.UInt32.__oldinit__ = std_msgs.msg.UInt32.__init__
std_msgs.msg.UInt32.__init__ = lambda self, data=0: std_msgs.msg.UInt32.__oldinit__(
    self, data=data
)
std_msgs.msg.UInt64.__oldinit__ = std_msgs.msg.UInt64.__init__
std_msgs.msg.UInt64.__init__ = lambda self, data=0: std_msgs.msg.UInt64.__oldinit__(
    self, data=data
)
std_msgs.msg.Float32.__oldinit__ = std_msgs.msg.Float32.__init__
std_msgs.msg.Float32.__init__ = lambda self, data=0.0: std_msgs.msg.Float32.__oldinit__(
    self, data=float(data)
)
std_msgs.msg.Float64.__oldinit__ = std_msgs.msg.Float64.__init__
std_msgs.msg.Float64.__init__ = lambda self, data=0.0: std_msgs.msg.Float64.__oldinit__(
    self, data=float(data)
)
std_msgs.msg.String.__oldinit__ = std_msgs.msg.String.__init__
std_msgs.msg.String.__init__ = lambda self, data="": std_msgs.msg.String.__oldinit__(
    self, data=data
)
std_msgs.msg.ColorRGBA.__oldinit__ = std_msgs.msg.ColorRGBA.__init__
std_msgs.msg.ColorRGBA.__init__ = (
    lambda self, r=0.0, g=0.0, b=0.0, a=0.0: std_msgs.msg.ColorRGBA.__oldinit__(
        self, r=float(r), g=float(g), b=float(b), a=float(a)
    )
)
std_msgs.msg.Header.__oldinit__ = std_msgs.msg.Header.__init__
# seq is deprecated/nonexistent in ROS2
std_msgs.msg.Header.seq = property(lambda self: 0, lambda self: None)
std_msgs.msg.Header.__init__ = lambda self, seq=0, stamp=builtin_interfaces.msg.Time(), frame_id="": std_msgs.msg.Header.__oldinit__(
    self, stamp=stamp, frame_id=frame_id
)
